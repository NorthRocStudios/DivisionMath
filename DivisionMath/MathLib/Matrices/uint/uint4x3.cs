...
{
    /// <summary>
    /// Represents a 4x3 uint matrix (4 rows, 3 columns) in column-major order (matching HLSL conventions).
    /// </summary>
    ...
    public struct uint4x3
    {
        ...
        public uint4x3(uint4 c0, uint4 c1, uint4 c2) { this.c0 = c0; this.c1 = c1; this.c2 = c2; }
        public uint4x3(uint[,] m)
        {
        ...
        public static uint4x3 zero => new uint4x3(0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u);

        public static uint4x3 operator +(uint4x3 a, uint4x3 b) => new uint4x3(a.c0 + b.c0, a.c1 + b.c1, a.c2 + b.c2);
        public static uint4x3 operator -(uint4x3 a, uint4x3 b) => new uint4x3(a.c0 - b.c0, a.c1 - b.c1, a.c2 - b.c2);
        public static uint4x3 operator *(uint4x3 m, uint s) => new uint4x3(m.c0 * s, m.c1 * s, m.c2 * s);
        public static uint4x3 operator *(uint s, uint4x3 m) => new uint4x3(m.c0 * s, m.c1 * s, m.c2 * s);
        public static uint4x3 operator /(uint4x3 m, uint s) => new uint4x3(m.c0 / s, m.c1 / s, m.c2 / s);
        public static uint4x3 operator +(uint4x3 m) => m;
        public static uint4 operator *(uint4x3 m, uint3 v) => mul(m, v);
        public static uint3 operator *(uint4 v, uint4x3 m) => mul(v, m);

        public static uint4x3 mul(uint4x3 m, uint s) => m * s;
        public static uint4 mul(uint4x3 m, uint3 v) => m.c0 * v.x + m.c1 * v.y + m.c2 * v.z;
        public static uint3 mul(uint4 v, uint4x3 m) => new uint3(
        ...
        public static uint4x2 mul(uint4x3 a, uint3x2 b) => new uint4x2(
            a.c0 * b.c0.x + a.c1 * b.c0.y + a.c2 * b.c0.z,
            a.c0 * b.c1.x + a.c1 * b.c1.y + a.c2 * b.c1.z);
        public static uint4x3 mul(uint4x3 a, uint3x3 b) => new uint4x3(
            a.c0 * b.c0.x + a.c1 * b.c0.y + a.c2 * b.c0.z,
            a.c0 * b.c1.x + a.c1 * b.c1.y + a.c2 * b.c1.z,
            a.c0 * b.c2.x + a.c1 * b.c2.y + a.c2 * b.c2.z);
        public static uint4x4 mul(uint4x3 a, uint3x4 b) => new uint4x4(
            a.c0 * b.c0.x + a.c1 * b.c0.y + a.c2 * b.c0.z,
            a.c0 * b.c1.x + a.c1 * b.c1.y + a.c2 * b.c1.z,
            a.c0 * b.c2.x + a.c1 * b.c2.y + a.c2 * b.c2.z,
            a.c0 * b.c3.x + a.c1 * b.c3.y + a.c2 * b.c3.z);

        public static uint3x4 transpose(uint4x3 m) => new uint3x4(
        ...
        public static bool operator ==(uint4x3 a, uint4x3 b) => (a.c0 == b.c0).all && (a.c1 == b.c1).all && (a.c2 == b.c2).all;
        public static bool operator !=(uint4x3 a, uint4x3 b) => !(a == b);
        public override readonly bool Equals(object? obj) => obj is uint4x3 o && this == o;
        public override readonly int GetHashCode() => HashCode.Combine(c0, c1, c2);

        public override readonly string ToString() => $"uint4x3({c0.x}, {c1.x}, {c2.x},  {c0.y}, {c1.y}, {c2.y},  {c0.z}, {c1.z}, {c2.z},  {c0.w}, {c1.w}, {c2.w})";

        public static implicit operator float4x3(uint4x3 m) => new float4x3(
            m.c0.x, m.c1.x, m.c2.x,
            m.c0.y, m.c1.y, m.c2.y,
            m.c0.z, m.c1.z, m.c2.z,
            m.c0.w, m.c1.w, m.c2.w);
        public static implicit operator int4x3(uint4x3 m) => new int4x3(
            (int)m.c0.x, (int)m.c1.x, (int)m.c2.x,
            (int)m.c0.y, (int)m.c1.y, (int)m.c2.y,
            (int)m.c0.z, (int)m.c1.z, (int)m.c2.z,
            (int)m.c0.w, (int)m.c1.w, (int)m.c2.w);
        public static implicit operator double4x3(uint4x3 m) => new double4x3(
            m.c0.x, m.c1.x, m.c2.x,
            m.c0.y, m.c1.y, m.c2.y,
            m.c0.z, m.c1.z, m.c2.z,
            m.c0.w, m.c1.w, m.c2.w);

        public static implicit operator uint4x4(uint4x3 m) => new uint4x4(
            m.c0.x, m.c1.x, m.c2.x, 0u,
            m.c0.y, m.c1.y, m.c2.y, 0u,
            m.c0.z, m.c1.z, m.c2.z, 0u,
            m.c0.w, m.c1.w, m.c2.w, 1u);
    }
}
