...
{
    /// <summary>
    /// Represents a 2x3 matrix (2 rows, 3 columns) in column-major order (matching HLSL conventions).
    /// </summary>
    ...
    public struct float2x3
    {
        ...
        public float2x3(float2 c0, float2 c1, float2 c2) { this.c0 = c0; this.c1 = c1; this.c2 = c2; }
        ...
        public static float2x3 operator +(float2x3 a, float2x3 b) => new float2x3(a.c0 + b.c0, a.c1 + b.c1, a.c2 + b.c2);
        public static float2x3 operator -(float2x3 a, float2x3 b) => new float2x3(a.c0 - b.c0, a.c1 - b.c1, a.c2 - b.c2);
        public static float2x3 operator *(float2x3 m, float s) => new float2x3(m.c0 * s, m.c1 * s, m.c2 * s);
        public static float2x3 operator *(float s, float2x3 m) => new float2x3(m.c0 * s, m.c1 * s, m.c2 * s);
        public static float2x3 operator /(float2x3 m, float s) => new float2x3(m.c0 / s, m.c1 / s, m.c2 / s);
        public static float2x3 operator -(float2x3 m) => new float2x3(-m.c0, -m.c1, -m.c2);
        public static float2x3 operator +(float2x3 m) => m;
        public static float2 operator *(float2x3 m, float3 v) => mul(m, v);
        public static float3 operator *(float2 v, float2x3 m) => mul(v, m);

        public static float2x3 mul(float2x3 m, float s) => m * s;
        public static float2 mul(float2x3 m, float3 v) => m.c0 * v.x + m.c1 * v.y + m.c2 * v.z;
        public static float3 mul(float2 v, float2x3 m) => new float3(
            v.x * m.c0.x + v.y * m.c0.y,
            v.x * m.c1.x + v.y * m.c1.y,
            v.x * m.c2.x + v.y * m.c2.y);

        public static float2x2 mul(float2x3 a, float3x2 b) => new float2x2(
            a.c0 * b.c0.x + a.c1 * b.c0.y + a.c2 * b.c0.z,
            a.c0 * b.c1.x + a.c1 * b.c1.y + a.c2 * b.c1.z);
        public static float2x3 mul(float2x3 a, float3x3 b) => new float2x3(
            a.c0 * b.c0.x + a.c1 * b.c0.y + a.c2 * b.c0.z,
            a.c0 * b.c1.x + a.c1 * b.c1.y + a.c2 * b.c1.z,
            a.c0 * b.c2.x + a.c1 * b.c2.y + a.c2 * b.c2.z);
        public static float2x4 mul(float2x3 a, float3x4 b) => new float2x4(
            a.c0 * b.c0.x + a.c1 * b.c0.y + a.c2 * b.c0.z,
            a.c0 * b.c1.x + a.c1 * b.c1.y + a.c2 * b.c1.z,
            a.c0 * b.c2.x + a.c1 * b.c2.y + a.c2 * b.c2.z,
        ...
        public static bool operator ==(float2x3 a, float2x3 b) => (a.c0 == b.c0).all && (a.c1 == b.c1).all && (a.c2 == b.c2).all;
        public static bool operator !=(float2x3 a, float2x3 b) => !(a == b);
        public override readonly bool Equals(object? obj) => obj is float2x3 o && this == o;
        public override readonly int GetHashCode() => HashCode.Combine(c0, c1, c2);

        public override readonly string ToString() => $"float2x3({c0.x}, {c1.x}, {c2.x},  {c0.y}, {c1.y}, {c2.y})";
